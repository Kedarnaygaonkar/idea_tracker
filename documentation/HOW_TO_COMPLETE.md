...
```bash
cd idea_tracker
python -c "import os, requests; headers={'Authorization': f'Bearer {os.getenv(\"OPENAI_API_KEY\")}'}; r=requests.get('https://openrouter.ai/api/v1/credits', headers=headers); print(r.json())"
```
